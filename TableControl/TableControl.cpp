...
TableControl::TableControl(int rMotorIn, int rMotorPWM, int lMotorIn, int lMotorPWM, int trigPin, int echoPin, int upButtonPin, int downButtonPin, int minHeight, int maxHeight, int inertiaСompensation) : motor(rMotorIn, rMotorPWM, lMotorIn, lMotorPWM), sensor(trigPin, echoPin), upButton(upButtonPin), downButton(downButtonPin) { 
